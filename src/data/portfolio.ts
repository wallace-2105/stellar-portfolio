...
export const personal = {
  ...
  cvUrl: "/Curriculo_Wallace_Coimbra_2026.pdf",
};
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    demo: "https://github.com/wallace-2105/controle-financeiro",
    features: [
      "Registro completo de receitas e despesas",
      "Dashboard visual com totais de saldo e gráficos",
      "Organização por categorias personalizáveis",
      "Filtragem por mês, ano e categoria",
    ],
  },
  {
    title: "Delivery AI",
...
export const certificates: Certificate[] = [
  ...
  {
    title: "Trabalhando com Amazon BedRock",
    issuer: "DIO",
    year: "2026",
    type: "course",
    image: dioLogo,
  ...
  {
    title: "Criando um Assistente de Delivery com AWS Step Functions e Bedrock",
    issuer: "DIO",
    year: "2026",
    type: "course",
    image: dioLogo,
