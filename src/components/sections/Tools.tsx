...
const TOOL_LOGOS: Record<string, React.ReactNode> = {
  ...
  "Visual Studio Code": (
    <svg className="w-full h-full" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="vscg-tools" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop stopColor="#2489CA" offset="0%" />
          <stop stopColor="#0065A9" offset="100%" />
        </linearGradient>
      </defs>
      <path d="M180.7 8.1l-121 93.5L25 72.7 0 85.8v84.4l25 13.1 34.7-28.9 121 93.5L256 225V31L180.7 8.1zM45.3 128l46.4-35.9v71.8L45.3 128zM180.7 196.6l-72.3-55.9h-.1L180.7 93V196.6z" fill="url(#vscg-tools)" />
    </svg>
  ),
  Figma: (
  ...
  Canva: (
    <svg className="w-full h-full" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M168.5 108.5c-2.6-7.7-8.3-13.2-15.3-13.2-14.4 0-25.8 18.8-25.8 42 0 14.4 5.5 23.5 14 23.5 6.1 0 11.8-4.8 15.7-12.5 1.4-2.8 3.5-3.8 5.3-2.6 1.8 1.2 2.1 4 .7 6.8-5.5 11-14.3 18.2-24.2 18.2-15.6 0-27-16.3-27-37.5 0-28.8 16.3-50.5 37.5-50.5 10.3 0 18.5 6.8 21.4 17.7 1 3.6-.2 6.7-2.3 8.1z" fill="white" />
    </svg>
  ),
  "Microsoft Word": (
    <svg className="w-full h-full" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
